...
(() => {
  ...
  function previewArt(t) {
    ...
    if (k === 'theme-baby-blue') return `<div class="midad-preview-art art-baby-blue"><div class="pv-top"><b></b><span></span><span></span></div><div class="pv-hero"><i></i><i></i></div><div class="pv-cards"><i></i><i></i><i></i></div></div>`;
    if (k === 'theme-aurora-glass') return `<div class="midad-preview-art art-aurora"><div class="pv-top"><b></b><span></span><em></em></div><div class="pv-glass"><i></i><i></i></div><div class="pv-grid"><i></i><i></i><i></i></div></div>`;
    if (k === 'theme-warda-pink') return `<div class="midad-preview-art art-warda"><div class="pv-top"><b></b><span></span><span></span></div><div class="pv-banner"><i></i><b></b></div><div class="pv-cards"><i></i><i></i><i></i></div></div>`;
  ...
  function installStyles() {
    ...
    s.textContent = `
      ...
      .art-baby-blue{background:linear-gradient(160deg,#e0f2fe,#f0f9ff);padding:9px}.art-baby-blue .pv-top{height:18px;border-radius:6px;background:#fff;border:1px solid #bae6fd;display:flex;align-items:center;gap:5px;padding:0 6px}.art-baby-blue .pv-top b{width:22px;height:7px;border-radius:4px;background:#38bdf8;margin-left:auto}.art-baby-blue .pv-top span{width:14px;height:5px;border-radius:4px;background:#bae6fd}.art-baby-blue .pv-hero{height:42px;margin-top:8px;background:rgba(255,255,255,.85);border:1px solid #7dd3fc;border-radius:10px;display:flex;gap:8px;padding:8px}.art-baby-blue .pv-hero i{flex:1;border-radius:6px;background:linear-gradient(135deg,#7dd3fc,#bae6fd)}.art-baby-blue .pv-hero i:last-child{max-width:32%;background:linear-gradient(135deg,#c4b5fd,#e0d7ff)}.art-baby-blue .pv-cards{display:grid;grid-template-columns:repeat(3,1fr);gap:6px;margin-top:7px}.art-baby-blue .pv-cards i{height:55px;border-radius:9px;background:#fff;border:1px solid #bae6fd}
      .art-aurora{background:linear-gradient(145deg,#eef2ff,#fdf2f8 55%,#ecfeff);padding:9px}.art-aurora .pv-top{height:18px;border-radius:6px;background:rgba(255,255,255,.65);border:1px solid rgba(99,102,241,.25);display:flex;align-items:center;gap:5px;padding:0 6px;backdrop-filter:blur(4px)}.art-aurora .pv-top b{width:24px;height:7px;border-radius:4px;background:linear-gradient(90deg,#6366f1,#ec4899);margin-left:auto}.art-aurora .pv-top span{width:14px;height:5px;border-radius:4px;background:#c7d2fe}.art-aurora .pv-top em{width:16px;height:7px;border-radius:4px;background:#67e8f9}.art-aurora .pv-glass{height:40px;margin-top:8px;background:rgba(255,255,255,.55);border:1px solid rgba(99,102,241,.2);border-radius:10px;display:flex;gap:8px;padding:8px;backdrop-filter:blur(6px)}.art-aurora .pv-glass i{flex:1;border-radius:6px;background:linear-gradient(135deg,rgba(99,102,241,.35),rgba(236,72,153,.25))}.art-aurora .pv-glass i:last-child{max-width:30%;background:linear-gradient(135deg,rgba(6,182,212,.4),rgba(165,180,252,.35))}.art-aurora .pv-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:6px;margin-top:7px}.art-aurora .pv-grid i{height:55px;border-radius:9px;background:rgba(255,255,255,.7);border:1px solid rgba(99,102,241,.18)}
      .art-warda{background:linear-gradient(160deg,#fdf2f8,#fff1f2);padding:9px}.art-warda .pv-top{height:18px;border-radius:6px;background:#fff;border:1px solid #fbcfe8;display:flex;align-items:center;gap:5px;padding:0 6px}.art-warda .pv-top b{width:22px;height:7px;border-radius:4px;background:#ec4899;margin-left:auto}.art-warda .pv-top span{width:14px;height:5px;border-radius:4px;background:#f9a8d4}.art-warda .pv-banner{height:38px;margin-top:8px;background:linear-gradient(135deg,#fce7f3,#fbcfe8);border:1px solid #f9a8d4;border-radius:10px;display:flex;align-items:center;gap:8px;padding:0 10px}.art-warda .pv-banner i{width:28px;height:18px;border-radius:5px;background:#ec4899}.art-warda .pv-banner b{flex:1;height:8px;border-radius:4px;background:#f9a8d4}.art-warda .pv-cards{display:grid;grid-template-columns:repeat(3,1fr);gap:6px;margin-top:7px}.art-warda .pv-cards i{height:55px;border-radius:9px;background:#fff;border:1px solid #fbcfe8}
